...
var MyTank=
{
id:null,X:null,Y:null,Life:null,Angle:null,cannonRelativeAngle:null,cannonAbsoluteAngle:null,trendMove:1,trendRotate:1};
var MT=MyTank;
var Timer=0;
var timeFire=0;
var timeViev=0;
...
{
var c=a.robot,d=a.scannedRobot;
...
}if(MT[b.id].status=='poisk')if(truTurn(b.cannonRelativeAngle) < 45)Rotated(a,1);
...
f=Math.round(f);
if(f!=0)if(f < 0)MT[b.id].trendRotate=1;
